...
(mbx_opening_element name: (identifier) @tag)
(mbx_closing_element name: (identifier) @tag)
(mbx_self_closing_element (identifier) @tag)
(mbx_attribute (property_identifier) @attribute)
